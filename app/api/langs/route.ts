...
export async function GET() {
  ...
  try {
    ...
    return new NextResponse(
      `<svg xmlns="http://www.w3.org/2000/svg" width="450" height="230"><rect width="410" height="190" x="20" y="20" rx="20" fill="rgba(255,255,255,0.03)" stroke="#00E5FF" stroke-opacity="0.2"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="#8B949E">Languages data unavailable</text></svg>`,
      {
        headers: {
          "Content-Type": "image/svg+xml",
